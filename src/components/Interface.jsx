...
const Interface = (props) => {
  ...
  const [leftCopyState, setLeftCopyState] = useState("IDLE");
  const [rightCopyState, setRightCopyState] = useState("IDLE");
